      ...
      <main className="w-full">
          ...
          <div className="container mx-auto max-w-6xl space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">Our Core Identity</h2>
        ...
        <section className="py-10 md:py-16 px-4 bg-card/30">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground text-center mb-8">Our Guiding Principles</h2>
