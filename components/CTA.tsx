  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-3xl text-center relative z-10">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-4">Ready to Partner With Us?</h2>
          ...
          <motion.a
            ...
            className="inline-block px-6 py-2 bg-accent text-accent-foreground rounded-full font-bold text-md transition-all shadow-2xl hover:bg-accent/90" // Enhanced button styling
          >
            Get in Touch Now
          </motion.a>
        </motion.div>
